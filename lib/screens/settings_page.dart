...
class _SettingsPageState extends State<SettingsPage> {
  ...
  List<SettingIntent> get _filtered {
    if (_query.isEmpty) return kSettingsIntents;
    return kSettingsIntents
  ...
  Widget build(BuildContext context) {
    ...
    final pinned = filtered.where((e) => _pinnedIds.contains(e.id)).toList();
    final others = filtered.where((e) => !_pinnedIds.contains(e.id)).toList();
        ...
        return Column(
          children: [
            ...
            _TopBar(
              ...
              totalCount: kSettingsIntents.length,
                  ...
                  : CustomScrollView(
                      slivers: [
                        ...
                        if (others.isNotEmpty) ...[
                          _SectionHeader(
                            icon: Icons.settings,
                            label: pinned.isEmpty ? 'All Settings' : 'Other Settings',
                            count: others.length,
                          ),
                          _IntentChipGrid(
                            items: others,
          ...
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Search in $totalCount intents…',
...
// ---------------------------------------------------------------------------
// Individual chip with right-click / long-press context menu
// ---------------------------------------------------------------------------
