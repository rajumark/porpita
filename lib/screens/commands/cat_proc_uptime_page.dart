...
class CatProcUptimePage extends StatefulWidget {
  const CatProcUptimePage({super.key});

  @override
  State<CatProcUptimePage> createState() => _CatProcUptimePageState();
}

class _CatProcUptimePageState extends State<CatProcUptimePage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await CatProcUptimeService.fetch(deviceId);
    if (mounted) {
      setState(() {
