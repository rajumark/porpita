...
class DumpsysAppopsPage extends StatefulWidget {
  const DumpsysAppopsPage({super.key});

  @override
  State<DumpsysAppopsPage> createState() => _DumpsysAppopsPageState();
}

class _DumpsysAppopsPageState extends State<DumpsysAppopsPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await DumpsysAppopsService.fetch(deviceId);
    if (mounted) {
      setState(() {
