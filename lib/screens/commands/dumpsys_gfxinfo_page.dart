...
class DumpsysGfxinfoPage extends StatefulWidget {
  const DumpsysGfxinfoPage({super.key});

  @override
  State<DumpsysGfxinfoPage> createState() => _DumpsysGfxinfoPageState();
}

class _DumpsysGfxinfoPageState extends State<DumpsysGfxinfoPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await DumpsysGfxinfoService.fetch(deviceId);
    if (mounted) {
      setState(() {
