...
class CatProcMeminfoPage extends StatefulWidget {
  const CatProcMeminfoPage({super.key});

  @override
  State<CatProcMeminfoPage> createState() => _CatProcMeminfoPageState();
}

class _CatProcMeminfoPageState extends State<CatProcMeminfoPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await CatProcMeminfoService.fetch(deviceId);
    if (mounted) {
      setState(() {
