...
class PmListPermissionsPage extends StatefulWidget {
  const PmListPermissionsPage({super.key});

  @override
  State<PmListPermissionsPage> createState() => _PmListPermissionsPageState();
}

class _PmListPermissionsPageState extends State<PmListPermissionsPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await PmListPermissionsService.fetch(deviceId);
    if (mounted) {
      setState(() {
