...
class GetpropPage extends StatefulWidget {
  const GetpropPage({super.key});

  @override
  State<GetpropPage> createState() => _GetpropPageState();
}

class _GetpropPageState extends State<GetpropPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await GetpropService.fetch(deviceId);
    if (mounted) {
      setState(() {
