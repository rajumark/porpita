...
class DumpsysBugreportPage extends StatefulWidget {
  const DumpsysBugreportPage({super.key});

  @override
  State<DumpsysBugreportPage> createState() => _DumpsysBugreportPageState();
}

class _DumpsysBugreportPageState extends State<DumpsysBugreportPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await DumpsysBugreportService.fetch(deviceId);
    if (mounted) {
      setState(() {
