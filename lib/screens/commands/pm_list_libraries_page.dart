...
class PmListLibrariesPage extends StatefulWidget {
  const PmListLibrariesPage({super.key});

  @override
  State<PmListLibrariesPage> createState() => _PmListLibrariesPageState();
}

class _PmListLibrariesPageState extends State<PmListLibrariesPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await PmListLibrariesService.fetch(deviceId);
    if (mounted) {
      setState(() {
