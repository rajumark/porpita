...
class DumpsysActivityTopPage extends StatefulWidget {
  const DumpsysActivityTopPage({super.key});

  @override
  State<DumpsysActivityTopPage> createState() => _DumpsysActivityTopPageState();
}

class _DumpsysActivityTopPageState extends State<DumpsysActivityTopPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await DumpsysActivityTopService.fetch(deviceId);
    if (mounted) {
      setState(() {
