...
class CatProcVersionPage extends StatefulWidget {
  const CatProcVersionPage({super.key});

  @override
  State<CatProcVersionPage> createState() => _CatProcVersionPageState();
}

class _CatProcVersionPageState extends State<CatProcVersionPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await CatProcVersionService.fetch(deviceId);
    if (mounted) {
      setState(() {
