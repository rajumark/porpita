...
class DumpsysSensorPage extends StatefulWidget {
  const DumpsysSensorPage({super.key});

  @override
  State<DumpsysSensorPage> createState() => _DumpsysSensorPageState();
}

class _DumpsysSensorPageState extends State<DumpsysSensorPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await DumpsysSensorService.fetch(deviceId);
    if (mounted) {
      setState(() {
