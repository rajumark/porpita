...
class DumpsysPowerPage extends StatefulWidget {
  const DumpsysPowerPage({super.key});

  @override
  State<DumpsysPowerPage> createState() => _DumpsysPowerPageState();
}

class _DumpsysPowerPageState extends State<DumpsysPowerPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await DumpsysPowerService.fetch(deviceId);
    if (mounted) {
      setState(() {
