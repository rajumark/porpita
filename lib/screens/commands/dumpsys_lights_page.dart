...
class DumpsysLightsPage extends StatefulWidget {
  const DumpsysLightsPage({super.key});

  @override
  State<DumpsysLightsPage> createState() => _DumpsysLightsPageState();
}

class _DumpsysLightsPageState extends State<DumpsysLightsPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await DumpsysLightsService.fetch(deviceId);
    if (mounted) {
      setState(() {
