...
class CatProcModulesPage extends StatefulWidget {
  const CatProcModulesPage({super.key});

  @override
  State<CatProcModulesPage> createState() => _CatProcModulesPageState();
}

class _CatProcModulesPageState extends State<CatProcModulesPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await CatProcModulesService.fetch(deviceId);
    if (mounted) {
      setState(() {
