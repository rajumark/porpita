...
class DumpsysSurfaceflingerPage extends StatefulWidget {
  const DumpsysSurfaceflingerPage({super.key});

  @override
  State<DumpsysSurfaceflingerPage> createState() => _DumpsysSurfaceflingerPageState();
}

class _DumpsysSurfaceflingerPageState extends State<DumpsysSurfaceflingerPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await DumpsysSurfaceflingerService.fetch(deviceId);
    if (mounted) {
      setState(() {
