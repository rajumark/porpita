...
class CatProcCpuinfoPage extends StatefulWidget {
  const CatProcCpuinfoPage({super.key});

  @override
  State<CatProcCpuinfoPage> createState() => _CatProcCpuinfoPageState();
}

class _CatProcCpuinfoPageState extends State<CatProcCpuinfoPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await CatProcCpuinfoService.fetch(deviceId);
    if (mounted) {
      setState(() {
