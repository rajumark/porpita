...
class CatProcNetDevPage extends StatefulWidget {
  const CatProcNetDevPage({super.key});

  @override
  State<CatProcNetDevPage> createState() => _CatProcNetDevPageState();
}

class _CatProcNetDevPageState extends State<CatProcNetDevPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await CatProcNetDevService.fetch(deviceId);
    if (mounted) {
      setState(() {
