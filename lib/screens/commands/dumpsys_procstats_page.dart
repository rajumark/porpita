...
class DumpsysProcstatsPage extends StatefulWidget {
  const DumpsysProcstatsPage({super.key});

  @override
  State<DumpsysProcstatsPage> createState() => _DumpsysProcstatsPageState();
}

class _DumpsysProcstatsPageState extends State<DumpsysProcstatsPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await DumpsysProcstatsService.fetch(deviceId);
    if (mounted) {
      setState(() {
