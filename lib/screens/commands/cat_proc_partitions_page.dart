...
class CatProcPartitionsPage extends StatefulWidget {
  const CatProcPartitionsPage({super.key});

  @override
  State<CatProcPartitionsPage> createState() => _CatProcPartitionsPageState();
}

class _CatProcPartitionsPageState extends State<CatProcPartitionsPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await CatProcPartitionsService.fetch(deviceId);
    if (mounted) {
      setState(() {
