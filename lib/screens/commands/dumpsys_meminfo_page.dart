...
class DumpsysMeminfoPage extends StatefulWidget {
  const DumpsysMeminfoPage({super.key});

  @override
  State<DumpsysMeminfoPage> createState() => _DumpsysMeminfoPageState();
}

class _DumpsysMeminfoPageState extends State<DumpsysMeminfoPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await DumpsysMeminfoService.fetch(deviceId);
    if (mounted) {
      setState(() {
