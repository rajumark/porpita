...
class DumpsysAppSearchPage extends StatefulWidget {
  const DumpsysAppSearchPage({super.key});

  @override
  State<DumpsysAppSearchPage> createState() => _DumpsysAppSearchPageState();
}

class _DumpsysAppSearchPageState extends State<DumpsysAppSearchPage> {
  String _output = '';
  bool _loading = false;
  String? _deviceId;
  ...
  Future<void> _fetch(String deviceId) async {
    ...
    final out = await DumpsysAppSearchService.fetch(deviceId);
    if (mounted) {
      setState(() {
