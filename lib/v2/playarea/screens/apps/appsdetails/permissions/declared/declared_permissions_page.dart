...
class DeclaredPermissionsPage extends StatefulWidget {
  ...
  @override
  State<DeclaredPermissionsPage> createState() => _DeclaredPermissionsPageState();
}

class _DeclaredPermissionsPageState extends State<DeclaredPermissionsPage> with AutomaticKeepAliveClientMixin {
        ...
        return Padding(
          ...
          child: Row(
            children: [
              ...
              if (p.protectionLevel.isNotEmpty) ...[
