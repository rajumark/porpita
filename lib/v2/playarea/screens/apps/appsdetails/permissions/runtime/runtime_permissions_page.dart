...
class RuntimePermissionsPage extends StatefulWidget {
  ...
  const RuntimePermissionsPage({super.key, required this.packageName});

  @override
  State<RuntimePermissionsPage> createState() => _RuntimePermissionsPageState();
}

class _RuntimePermissionsPageState extends State<RuntimePermissionsPage> with AutomaticKeepAliveClientMixin {
